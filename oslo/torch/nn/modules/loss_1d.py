...
# Find what global_context is!!
# colossal ai : ParallelMode.TENSOR_1D ==> ParallelMode.PARALLEL_1D
...
class _VocabParallelCrossEntropy1D(torch.autograd.Function):
    ...
    def forward(ctx, vocab_parallel_logits, targets, process_group):
        ...
        # process_group = gpc.get_group(ParallelMode.TENSOR_1D)
        ...
        # Get the partition's vocab indicies
    ...
    def backward(ctx, grad_output):
        ...
        return grad_input, None, None  # TODO: check Megatron has 2 output instead of 3
